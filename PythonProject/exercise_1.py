...
def get_name():
    while True:
        ...
        if last_name and all(char.isalpha() or char in "- " for char in last_name): # Проверяем, что фамилия не пустая и не содержит цифр TODO: Обсудить подробнее, как это работает
